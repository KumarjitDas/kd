...
#define KD_MEM_ALGN_VERSION_MAJOR  0
#define KD_MEM_ALGN_VERSION_MINOR  0
#define KD_MEM_ALGN_VERSION_PATCH  1

#define KD_MEM_ALGN_VERSION_CSTR   KDI_STRINGIFY(KD_MEM_ALGN_VERSION_MAJOR) "." KDI_STRINGIFY(KD_MEM_ALGN_VERSION_MINOR) "." KDI_STRINGIFY(KD_MEM_ALGN_VERSION_PATCH)
#define KD_MEM_ALGN_VERSION_ARR    {KD_MEM_ALGN_VERSION_MAJOR, KD_MEM_ALGN_VERSION_MINOR, KD_MEM_ALGN_VERSION_PATCH}
